...
library NFTDescriptor {
    ...
    function generateSVGImage(
        ...
        NFTSVG.SVGParams memory svgParams = NFTSVG.SVGParams({
            ...
            head: addressToString(params.head),
            name: params.name,
            duration: params.duration,
            pollinationScore: params.pollinationScore,
            villagerCount: params.villagerCount,
            color0: params.color0,
            color1: params.color1,
            color2: params.color2,
            color3: params.color3,
            x1: scale(
                getCircleCoord(uint256(params.head), 16, params.tokenId),
                0,
                255,
                16,
                274
            ...
            y1: scale(
                getCircleCoord(
                    uint256(params.pollinationScore),
                    16,
                    params.tokenId
                ),
                0,
            ...
            x2: scale(
                getCircleCoord(uint256(params.head), 32, params.tokenId),
                0,
                255,
                16,
                274
            ...
            x3: scale(
                getCircleCoord(uint256(params.head), 48, params.tokenId),
                0,
                255,
                16,
                274
